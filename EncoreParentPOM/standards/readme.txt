...
// This is just a test a second test
//master

The files in this directory are Encore Application standard configurations.


ECLIPSE FORMATTER
   1. Load the Encore Application standard configuration for the Eclipse formatter, found in
...
ECLIPSE CLEANUP
   1. Load the Encore Application standard configuration for the Eclipse cleanup, found in
         http://subversion/svn/CodeStandards/JavaCodeStandards/trunk/
...
PMD/CPD
   ...
   4. Load the Encore Application standard PMD configuration for Eclipse, available from
         http://subversion/svn/CodeStandards/JavaCodeStandards/trunk/
